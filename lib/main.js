  ...
  setup: function setup() {
    return {
      links: [{
        ...
        deployBadge: 'https://github.com/thefirstspine/matches/actions/workflows/deploy.yml/badge.svg',
      }, {
        part: 'services',
        color: 'danger',
        icon: 'fas fa-user',
        ...
        deployBadge: 'https://github.com/thefirstspine/bots/actions/workflows/deploy.yml/badge.svg',
      }, {
        part: 'services',
        color: 'danger',
        ...
        deployBadge: 'https://github.com/thefirstspine/calendar/actions/workflows/deploy.yml/badge.svg',
      }, {
        part: 'services',
        color: 'danger',
        icon: 'fas fa-bell',
        ...
        deployBadge: 'https://github.com/thefirstspine/rest/actions/workflows/deploy.yml/badge.svg',
      }, {
        part: 'services',
        color: 'danger',
        ...
        deployBadge: 'https://github.com/thefirstspine/rooms/actions/workflows/deploy.yml/badge.svg',
      }, {
        part: 'services',
        color: 'danger',
        ...
        deployBadge: 'https://github.com/thefirstspine/shop/actions/workflows/deploy.yml/badge.svg',
      }, {
        part: 'services',
        color: 'danger',
        ...
        deployBadge: 'https://github.com/thefirstspine/website/actions/workflows/deploy.yml/badge.svg',
      }, {
        part: 'tools',
        color: 'success',
        icon: 'fas fa-stamp',
        ...
        deployBadge: 'https://github.com/thefirstspine/arena/actions/workflows/deploy.yml/badge.svg',
      }, {
        part: 'projects',
        color: 'warning',
        icon: 'fas fa-chess-rook',
        ...
        deployBadge: 'https://github.com/thefirstspine/arena-client/actions/workflows/deploy.yml/badge.svg',
      }].sort(byName)
    };
  }
